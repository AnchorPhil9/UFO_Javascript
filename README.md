...
## Changes Made
In Dana's first webpage, users had access to the entire table of Dana's UFO data, and if they wished, they could filter the information by date (in MM/DD/YYYY format) with the click of a button. Still, when looking up days with plenty of UFO data like 1/1/2010, users who are after more specific parameters (like circle-shaped UFOs) may not like having to use their browser's Find function to single out their ideal data entries. 
